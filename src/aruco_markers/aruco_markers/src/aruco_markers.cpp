...
public:
  ...
  : Node("aruco_markers"), tf_buffer_(this->get_clock()), tf_listener_(tf_buffer_)
  {
    ...
    this->declare_parameter("camera_frame", "front_cam_optical_frame");
    this->declare_parameter("image_topic", "/front_cam/color/image_raw");
    this->declare_parameter("camera_info_topic", "/front_cam/color/camera_info");
